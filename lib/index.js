...
function panel(id, options) {
  if (!panelList[id]) {
    ...
    var options = {
      ...
      canScrollPageWithDrag: (options.canScrollPageWithDrag === true ? true : false) // Default value is false
    }
    ...
    function mouseDown(e) {
      if (!options.canScrollPageWithDrag) { document.body.style.overflow = "hidden"; }
    ...
    function mouseUp() {
      ...
      if (!options.canScrollPageWithDrag) { document.body.style.overflow = "auto"; }
    }
