...
/**
 * Create a new panel.
 * @param {String} id      This sets the value of the id attribute of the created panel.
 * @param {Object} options Sets options to configure the panel.
 */
...
/**
 * Closes a panel.
 * @param {Node} frame The panel to close.
 */
...
/**
 * Restores a closed panel.
 * @param {Node} frame The panel to restore.
 */
...
/**
 * Change the color of the panel's frame.
 * @param {Node}    frame The panel to change color.
 * @param {Integer} color The color to change the panel to.
 */
...
/**
 * Change the color of the panel's frame to match the Windows theme color.
 * @param {Node} frame The panel to change color.
 */
